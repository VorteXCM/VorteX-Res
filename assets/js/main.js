document.addEventListener("DOMContentLoaded", async () => {
  ...
  async function loadResources() {
    try {
      ...
      console.error("خطا در بارگذاری resources.json:", e);
      return [];
    }
  }
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="tags">${(item.tags || [])
            ...
            .join("")}</div>
          <div class="actions">
            <a class="btn" href="${item.download_url}" target="_blank" rel="noopener">دانلود</a>
            <a class="btn ghost" href="docs.html#${item.id}">دستور نصب</a>
          </div>
        </div>
      </div>
    `;
